...
<div class="page-content container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <p>Saperstone Studios is a newborn and family photographer in Chandler,
                AZ. I love that I can offer my clients flexibility by having my own
        ...
        <div class="col-xs-12" style="padding-top: 20px;">
            ...
            <p>
                Newborn Sessions take place either at <a href='galleries.php?w=14'>your
                    home</a> or <a href='galleries.php?w=15'>my studio</a> in Chandler,
                AZ. You'll have full access to an array of beautiful props,
        ...
        <div class="col-xs-12" style="padding-top: 20px;">
            ...
            <ul>
                ...
                <li>The focus of this session is on the one child, but you may
                    include 2-3 sibling/family portraits
                </li>
            </ul>
        </div>
            ...
            <ul>
                <li>Includes 3 sessions total:
                    <ol>
                        ...
                        <li><a href="galleries.php?w=6">Family Photography Session</a> at some point in baby's 2nd year
                        </li>
                    </ol>
                </li>
        ...
        <div class="col-xs-12" style="padding-top: 20px;">
            ...
            <ul>
                ...
                <li>May include any combination of portraits you would like: whole
                    group, individuals, parents, kids, etc
                </li>
