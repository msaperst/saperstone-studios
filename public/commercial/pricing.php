    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            ...
            <ul>
                ...
                <li><a href='galleries.php?w=54'>On Location Headshot</a> at Saperstone Studios (located in Chandler,
                    AZ)
                </li>
        ...
        <div class="col-xs-8">
            ...
            <ul>
                ...
                <li><a href='galleries.php?w=54'>On Location Headshot</a> at a local park to Saperstone Studios
                    (Located in Chandler, AZ) or a <a href='galleries.php?w=53'>Studio Headshot</a> session
                </li>
