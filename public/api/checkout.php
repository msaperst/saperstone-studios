<?php
$path = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . "resources/merchant-sdk-php-3.9.1/lib";
...
$session = new Session();
$session->initialize();
require_once dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . "resources/merchant-sdk-php-3.9.1/samples/PPBootStrap.php";
...
try {
    ...
    require_once dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . "resources/merchant-sdk-php-3.9.1/samples/Error.php";
    exit ();
}
