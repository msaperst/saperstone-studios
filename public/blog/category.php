...
<div id="blog-page-config" class="hidden" data-loader="posts-full" data-total="<?php echo $postCount; ?>" data-tags="<?php echo Strings::escapeHtmlAttribute(json_encode($categories)); ?>"></div>
