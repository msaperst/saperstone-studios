    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <ul class="list-unstyled list-inline list-social-icons">
                <?php $iconSize = "fa-2x";
                require_once dirname($_SERVER['DOCUMENT_ROOT']) . DIRECTORY_SEPARATOR . "templates/social-list.php"; ?>
            </ul>
        </div>
    </div>
    <!-- /.row -->
                ...
                <div class="control-group form-group">
                    <div class="controls">
                        <label>Full Name:</label> <input type="text" class="form-control"
                                                         id="name" required value="<?php echo htmlspecialchars($user->getName(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>"
                ...
                <div class="control-group form-group">
                    <div class="controls">
                        <label>Email Address:</label> <input type="email"
                                                             ...
                                                             value="<?php echo htmlspecialchars($user->getEmail(), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8'); ?>"
