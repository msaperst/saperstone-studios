...
$sql = new Sql ();
$images = $sql->getRows( "SELECT gallery_images.* FROM `gallery_images` JOIN `galleries` ON gallery_images.gallery = galleries.id WHERE galleries.title = 'B\'nai Mitzvah';" );
$sql->disconnect();
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="page-content container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-center">B'nai Mitzvahs</h1>
                <ol class="breadcrumb">
                    <li><a href="/">Home</a></li>
                    <li class="active">B'nai Mitzvahs</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
                ...
                <div id="mitzvahCarousel"
                    ...
                    <ol class="carousel-indicators">
                        ...
                        foreach ( $images as $num => $image ) {
                            ...
                            echo "<li data-target='#mitzvahCarousel' data-slide-to='$num'$class></li>";
                        }
                        ?>
                    </ol>
                    ...
                    <!-- Controls -->
                    <a class="left carousel-control" href="#mitzvahCarousel"
                        data-slide="prev"> <span class="icon-prev"></span>
                    </a> <a class="right carousel-control" href="#mitzvahCarousel"
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div section='Gallery'
                    ...
                    <span class='preview-title'>Gallery</span> <img
                        ...
                        alt="Gallery">
                    <div class="overlay">
                        <br /> <br /> <br /> <a class="info" href="gallery.php?w=72">See
                            More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div section='Raves'
                    ...
                    <span class='preview-title'>Raves</span> <img
                        ...
                        alt="Raves">
                    <div class="overlay">
                        <br /> <br /> <br /> <a class="info" href="reviews.php?c=4">See
                            More</a>
                    </div>
                </div>
            </div>
