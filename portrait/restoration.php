...
<body>
	...
	<script>
	var images = [];
    images[0] = { thumb:'/retouch/img/portrait/restoration/10.jpg', orig:'/retouch/img/portrait/restoration/10-BEFORE.jpg', edit:'/retouch/img/portrait/restoration/10-AFTER.jpg', width:'565', height:'707', text:'' };
