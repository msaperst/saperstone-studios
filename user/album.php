                ...
                <div class="modal-footer">
                    <span class="pull-left">
                        ...
                        <button id="downloadable-image-btn"
                            ...
                            <em class="fa fa-download"></em> Download
                        </button> <!--                         <div id="not-downloadable-image-btn" -->
                        <!--                             class="tooltip-wrapper disabled" data-toggle="tooltip" -->
                        <!--                             data-placement="top" --> <!--                             title="Purchase full rights to this image in order to download it."> -->
                ...
                <div class="modal-footer">
                    <span class="pull-left">
                        ...
                        <button id="downloadable-favorites-btn"
                            ...
                            <em class="fa fa-download"></em> Download Favorites
                        </button> <!--                         <div id="not-downloadable-favorites-btn" -->
                        <!--                             class="tooltip-wrapper disabled" data-toggle="tooltip" -->
                        <!--                             data-placement="top" --> <!--                             title="Purchase full rights to these images in order to download them."> -->
                        <!--                             <button type="button" class="btn btn-default btn-action"> -->
                        <!--                                 <em class="fa fa-download"></em> Download Favorites -->
                        <!--                             </button> --> <!--                         </div> -->
                        ...
                        <!--                             class="tooltip-wrapper disabled" data-toggle="tooltip" -->
                        <!--                             data-placement="top" --> <!--                             title="Purchase social media rights to these images in order to share them on social media."> -->
                        <!--                             <button type="button" class="btn btn-default btn-action"> -->
                        <!--                                 <em class="fa fa-share"></em> Share Favorites -->
                        <!--                             </button> --> <!--                         </div> -->
                        <?php
    ...
    <nav class="navbar navbar-actions navbar-fixed-bottom breadcrumb">
        <div class="container text-center">
            ...
            <?php
                ...
                ?>
            <span class="text-center"><button id="downloadable-all-btn"
                    type="button" class="btn btn-default btn-action btn-success">
                    <em class="fa fa-download"></em> Download All
                </button></span> <span class="text-center"><button
