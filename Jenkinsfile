...
//                                         throw e  // TODO - commenting this out for now...
            ...
            stage('Publish Containers') {
                ...
                parallel(
                        "PHP": {
                            pushContainer(dockerRegistry, ['qa'], "${dockerRegistry}/php:ci", "php")
                        },
                        "PHP MyAdmin": {
                            pushContainer(dockerRegistry, ['qa'], "${dockerRegistry}/php-myadmin:ci", "php-myadmin")
                        },
                        "MySQL": {
                            pushContainer(dockerRegistry, ['qa'], "${dockerRegistry}/mysql:ci", "mysql")
                        }
                )
            }
            stage('Clean Up') {
