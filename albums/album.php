...
<body>
    ...
    <!-- Slideshow Modal -->
    <div id="album" album-id="<?php echo $_GET ['album']; ?>"
    ...
    <!-- Favorites Modal -->
    <div id="favorites" album-id="<?php echo $_GET ['album']; ?>"
        class="modal fade modal-carousel" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
    ...
    <div id="cart-image" album-id="<?php echo $_GET ['album']; ?>"
    ...
    <!-- Gallery Cart Modal -->
    <div id="cart" album-id="<?php echo $_GET ['album']; ?>"
        class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
