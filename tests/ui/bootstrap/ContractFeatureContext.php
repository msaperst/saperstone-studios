...
class ContractFeatureContext implements Context {
    ...
    public function cleanup() {
        ...
        $this->sql->disconnect();
        if (file_exists(dirname(dirname(dirname(__DIR__))) . 'content/contracts/Max - 2020-11-17 - Commercial Contract.pdf')) {
            unlink(dirname(dirname(dirname(__DIR__))) . 'content/contracts/Max - 2020-11-17 - Commercial Contract.pdf');
        }
    }
