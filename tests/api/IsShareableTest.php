...
class IsShareableTest extends TestCase {
    private $http;
    private $sql;
    ...
    public function setUp() {
        ...
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('3', 999, '990');");
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('0', 999, '991');");
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('3', '*', '992');");
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('0', '*', '993');");
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('0', '998', '995');");
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('5', '*', '996');");
        for ($i = 0; $i < 10; $i++) {
    ...
    public function tearDown() {
        ...
        $this->sql->executeStatement("DELETE FROM `share_rights` WHERE `image` LIKE '%99%%'");
        $this->sql->executeStatement("DELETE FROM `share_rights` WHERE `album` = '999'");
        $this->sql->executeStatement("DELETE FROM `share_rights` WHERE `album` = '*' AND `image` = '*' AND `user` = '0'");
        $this->sql->executeStatement("DELETE FROM `share_rights` WHERE `album` = '*' AND `image` = '*' AND `user` = '3'");
    ...
    public function testAdminHasAccess() {
        ...
        $response = $this->http->request('GET', 'api/is-shareable.php', [
            'cookies' => $cookieJar
        ]);
    ...
    public function testOpenImageYourAlbumYourUser() {
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('3', 999, '*');");
        $cookieJar = CookieJar::fromArray([
            'hash' => '5510b5e6fffd897c234cafe499f76146',
            'searched' => json_encode([
                999 => md5('album123')
    ...
    public function testOpenImageYourAlbumOpenUser() {
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('0', 999, '*');");
        $cookieJar = CookieJar::fromArray([
            'hash' => '5510b5e6fffd897c234cafe499f76146',
            'searched' => json_encode([
                999 => md5('album123')
    ...
    public function testOpenImageOpenAlbumYourUser() {
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('3', '*', '*');");
        $cookieJar = CookieJar::fromArray([
            'hash' => '5510b5e6fffd897c234cafe499f76146',
            'searched' => json_encode([
                999 => md5('album123')
    ...
    public function testOpenImageOpenAlbumOpenUser() {
        $this->sql->executeStatement("INSERT INTO `share_rights` (`user`, `album`, `image`) VALUES ('0', '*', '*');");
        $cookieJar = CookieJar::fromArray([
            'hash' => '5510b5e6fffd897c234cafe499f76146',
            'searched' => json_encode([
                999 => md5('album123')
