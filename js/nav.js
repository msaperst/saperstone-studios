...
$(function() {
                                        ...
                                        function(data) {
                                            if (data === "") {
                                                $('#login-modal .loginmodal-container')
                                                        .append(
                                                                "<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>Successfully Logged In. Please wait as you are redirected.</div>");
                                                location.reload();
                                            } else {
                                                $('#login-modal .loginmodal-container').append(
                        ...
                        $
                                ...
                                .done(
                                        function(data) {
                                            ...
                                            if (data === "") {
                                                $('#forgot-password-modal .loginmodal-container')
                                                        .append(
                                                                "<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>Reset code has been sent, please enter it below, along with a new password</div>");
                                                resetPasswordForm();
                                                button.prop("disabled", false);
                                            } else {
                                                $('#forgot-password-modal .loginmodal-container').append(
                                                        "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>" + data + "</div>");
                                            }
                                        })
                                .fail(
    ...
    $("#forgot-password-prev-code")
            .click(
                    function() {
                        $('#forgot-password-modal .loginmodal-container')
                                .append(
                                        "<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>Enter your email address above, with your previous reset code and a new password below</div>");
                        resetPasswordForm();
                    });
                                ...
                                .done(
                                        function(data) {
                                            ...
                                            if (data === "") {
                                                $('#forgot-password-modal .loginmodal-container')
                                                        .append(
                                                                "<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>Your password has been successfully reset. Logging you in now.</div>");
                                                location.reload();
                                            } else {
                                                $('#forgot-password-modal .loginmodal-container').append(
                                                        "<div class='alert alert-danger'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>" + data + "</div>");
                                ...
                                $
                                        ...
                                        .done(
                                                function(data) {
                                                    ...
                                                    // goto album url if it
                                                    // exists
                                                    if ($.isNumeric(data) && data !== '0') {
                                                        modal
                                                                .find('.bootstrap-dialog-body')
                                                                .append(
                                                                        "<div class='alert alert-info'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>Navigating to album</div>");
