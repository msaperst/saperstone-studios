    ...
    $.get( 
        ...
        function( data ) {
            BootstrapDialog.show({
                ...
                message: function(){
                    var inputs =  '<input placeholder="Gallery Title" id="new-gallery-title" type="text" class="form-control" value="' + data.title + '" />' +
                       '<p></p>' +
                       ...
                       '</div>' +
                       '<div id="new-gallery-error" class="error"></div>' +
                       '<div id="new-gallery-message" class="success"></div>';
                    return inputs;
                }, 
                buttons: [{
...
function disableDialogButtons(dialog) {
    ...
    uploadButton.css({'cursor':'not-allowed', 'pointer-events':'none'});
...
function enableDialogButtons(dialog) {
    ...
    uploadButton.css({'cursor':'pointer', 'pointer-events':'inherit'});
