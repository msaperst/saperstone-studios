                                ...
                                .done(
                                        function(data) {
                                            if (data === "") {
                                                ...
                                                $('#login-message')
                                                        .append(
                                                                "<div class='alert alert-info lead'><a href='#' class='close' data-dismiss='alert' aria-label='close' title='close'>×</a>We have recently upgraded our login accounts along with our website. None of your data is lost, but you will need to update your credentials in order to access your images.</div>");
                                                $('#login-button').hide();
                                                $('#login').hide();
